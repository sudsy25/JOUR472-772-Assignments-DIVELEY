...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer: Nevada, 35%**
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard county, 130000**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer: Household income by county in Maryland, with margin of error**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer: Maryland high schools with higher college enrollment rates tend to be located in wealthier zip codes.**
...
**Task** What is another question you could ask of this data? **Answer: I mean you can look at outliers in the data and ask why a certain lower income zip has such a high enrollment.**
