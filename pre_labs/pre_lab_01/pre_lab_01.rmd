...
**Answer: Now we are sorting by department instead of term, meaning now you can see the amount of classes and seats per department. It's then sorted by the median seats in descending order.**
