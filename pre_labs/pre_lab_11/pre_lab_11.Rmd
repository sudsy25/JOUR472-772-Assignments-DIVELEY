...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer: I guess if I could pull out a county or city, that could help me narrow searches.**
...
tags there are in the HTML source? **Answer: 94**
...
tags. Describe the output: **Answer: It just extracts the text, removes unnecessary things like links**
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer: It creates a dataframe of only the text.**
