...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
```{r}
class_response <- axolotr::ask(
  prompt = "Is a class structured with short pre-labs we learn as a class and longer labs to work on solo/in small groups together an effective way to learn data journalism? Answer in 4 sentences, plain language.",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: I believe the comment was pretty good, as it explained the benefits of the structure of the class.**
