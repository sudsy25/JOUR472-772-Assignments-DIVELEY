...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: First we add a new column for month. After we group by the month, we asses how many calls were within each month. Lastly we arrange starting from the highest number of calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: nothing, it is blank. just a grey box**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a vertical bar graph, with the x values arranged in chronological order. The Y is the number of calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: now it is arranged by lowest number of calls to highest**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: the bars are now horizontal, with the top being most calls to bottom being least**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: mostly the same, but the background changes to white, minimal themed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: the theme is now economist, like a light blue background.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: the axis are labeled correctly and the title is bolded. Also, there is a caption at the bottom adding a source.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: we have a new dataframe sorted by exact date instead of month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: there is now a line graph of the calls by date in chronological.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: the x-axis has labels per week, making it jumbled and overlapping.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer now the ticks are at an angle, makig them slightly easier to see.**
