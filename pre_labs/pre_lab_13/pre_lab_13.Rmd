...
**Task** Run the following code and describe the dataframe it outputs. **Answer: 50 rows and 5 columns, each row is a state. The columns consist of education spending, GDP growth, population change, and the 2020 vote.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: The plot shows an upwards trend, so higher population growth leads to higher GDP growth. It's not the strongest connection.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: The plot now shows a flatline or no correlation between the 2 variables.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: It looks like all the correlations are relatively weak, no matter if they are positive or negative.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The test shows the negative correlation of -.41, showing its statistically significant.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The correlation is a weak -.06 and the p-value is high, showing that the result is not statistically significant**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: Biden won states have a higher mean GDP and education spending, but Trump states have higher population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: Despite the different numbers, the p-value is over .05, so the difference isn't statistically significant.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value is very very small, so the gap is significantly significant.**
